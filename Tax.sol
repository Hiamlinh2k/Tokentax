...
contract FlowerPal {
    ...
    string public constant name = "Flower Pal";   
    string public constant symbol = "FLOWERPAL";   
    ...
    address payable constant deployer = payable(address(0x398A714077480eC6ceCf7b0994DCaEDd009Afec5));
